...
df = pd.read_csv("antennaMeasurements.csv", header=None, index_col=0)
print(df)
...
straightconcat = [*straightonRow1Coords, *straightonRow2Coords, *straightonRow3Coords, *straightonRow4Coords]
...
ninetyconcat = [*ninetyRow1Coords, *ninetyRow2Coords, *ninetyRow3Coords, *ninetyRow4Coords]
...
plt.scatter([1,2,3,4], [oneMeterAvg, twoMeterAvg, threeMeterAvg, fourMeterAvg], color="pink", label="Averages")
